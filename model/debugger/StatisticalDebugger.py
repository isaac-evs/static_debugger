...
Debugger = Union[OchiaiDebugger, TarantulaDebugger, RankingDebugger, ContinuousSpectrumDebugger, DiscreteSpectrumDebugger, SpectrumDebugger, DifferenceDebugger, StatisticalDebugger]
