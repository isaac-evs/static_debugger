...
This class is in charge of refining hypotheses to repair a defect.
...
class AbductionSchema(Enum):
    ...
    available abduction schemes. """
    DFS = 1
    BFS = 2
    A_star = 3

class HypothesisRefinement(ModelConstructor):
    """ This class is used to refine a hypothesis. """
    ...
    def select_imprv_candidate(self) -> Hypothesis:
        """ This method returns the next improvement candidate in the iterator.
        :rtype: int
        """
    ...
    def sort_imprv_candidates(hypotheses: Hypotheses, 
        ...
        The hypotheses will be sorted by explanatory power
        and turned into an Iterator.
